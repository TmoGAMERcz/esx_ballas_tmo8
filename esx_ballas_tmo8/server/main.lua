...
RegisterNetEvent('esx_ballas:confiscatePlayerItem')
AddEventHandler('esx_ballas:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if sourceXPlayer.job.name ~= 'ballas' then
		print(('esx_ballas: %s attempted to confiscate!'):format(sourceXPlayer.identifier))
		return
	end
...
AddEventHandler('esx_ballas:handcuff', function(target)
	...
	if xPlayer.job.name == 'ballas' then
		...
		print(('esx_ballas: %s attempted to handcuff a player (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_ballas:drag', function(target)
	...
	if xPlayer.job.name == 'ballas' then
		...
		print(('esx_ballas: %s attempted to drag (not cop)!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_ballas:putInVehicle', function(target)
	...
	if xPlayer.job.name == 'ballas' then
		...
		print(('esx_ballas: %s attempted to put in vehicle (not cop)!'):format(xPlayer.identifier))
	end
end)
...
RegisterNetEvent('esx_ballas:getStockItem')
...
RegisterNetEvent('esx_ballas:putStockItems')
...
ESX.RegisterServerCallback('esx_ballas:getOtherPlayerData', function(source, cb, target, notify)
...
ESX.RegisterServerCallback('esx_ballas:storeNearbyVehicle', function(source, cb, plates)
	local xPlayer = ESX.GetPlayerFromId(source)
...
AddEventHandler('playerDropped', function()
	...
	if playerId then
		...
		if xPlayer and xPlayer.job.name == 'ballas' then
			Wait(5000)
...
RegisterNetEvent('esx_ballas:spawned')
...
RegisterNetEvent('esx_ballas:forceBlip')
AddEventHandler('esx_ballas:forceBlip', function()
	for _, xPlayer in pairs(ESX.GetExtendedPlayers('job', 'ballas')) do
		TriggerClientEvent('esx_ballas:updateBlip', xPlayer.source)
	end
end)
